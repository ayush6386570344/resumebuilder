  ...
  return (
    <div className="mt-8 rounded-3xl bg-zinc-900 border border-zinc-800 p-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        <BrainCircuit className="text-green-400" size={30} />
      ...
      <div className="space-y-4">
       ...
       {questions.map((item, index) => (
          <div
            key={index}
            className="flex gap-4 p-5 rounded-2xl bg-zinc-800 border border-zinc-700 hover:border-green-500 transition"
          >
